...
(load (concat config-basedir "/rc/prog/lang/rc-ccmode.el"))
(load (concat config-basedir "/rc/prog/lang/rc-elisp.el"))
...
(load (concat config-basedir "/rc/prog/lang/rc-python.el"))
(load (concat config-basedir "/rc/prog/lang/rc-php.el"))
(load (concat config-basedir "/rc/prog/lang/rc-scheme.el"))
