...
(setq org-capture-templates
      '(("d" "todo")
        ...
        ("dey" "emacs try" entry (file (at-config-basedir "totry.org")) "* %? %U :emacs:try:")
        ("dp" "project ideas" entry (file (at-org-dir "/projectideas.org")) "* %? %U :project:idea:")
        ("dx" "xmonad tickets" entry (file+headline (at-homedir "/.xmonad/todo.org")) "* TODO [#C] %? %U :xmonad:ticket:")
        ...
        ("jn" "notes" entry (file (at-org-dir "/job-notes.org")) "* %? %U :work:notes:") ;initial storage for quick notes at work; subject to change
        ...
        ("gl" "CL repo to review" entry (file+headline (at-org-dir "/mastering/cl.org") "repos") "* %? %U :github:common-lisp:")
