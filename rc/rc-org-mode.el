...
(define-key custom-pim-keymap (kbd "g") 'org-clock-goto)
(define-key custom-pim-keymap (kbd "p") 'org-set-property)
(define-key custom-pim-keymap (kbd "d") 'org-delete-property)
(define-key custom-pim-keymap (kbd "s") 'org-schedule)
(define-key custom-pim-keymap (kbd "l") 'org-deadline)
(define-key custom-pim-keymap (kbd ".") 'org-clock-in)
(define-key custom-pim-keymap (kbd ",") 'org-clock-out)
(define-key custom-pim-keymap (kbd "k") 'org-clock-display)
(define-key custom-pim-keymap (kbd "c") 'org-agenda-columns)
(define-key custom-pim-keymap (kbd "n") 'org-footnote-action)
(define-key custom-pim-keymap (kbd "w") 'org-store-link)
(define-key custom-pim-keymap (kbd "y") 'org-insert-link)
(define-key custom-pim-keymap (kbd "i") 'update-timestamp-with-time)
