...
(setq org-capture-templates
      '(("d" "todo")
        ...
        ("by" "essays" entry (file+olp (at-org-dir "/browser-tabs.org") "inbox" "essays") "* TODO [#C] %? %U :browser_tab:essay:")
        ("bh" "habr" entry (file+olp (at-org-dir "/browser-tabs.org") "inbox" "habr") "* TODO [#C] %? %U :browser_tab:habr:")
        ("bs" "services/sites" entry (file+olp (at-org-dir "/browser-tabs.org") "inbox" "services/sites") "* TODO [#C] %? %U :browser_tab:site:")
        ("bf" "facebook" entry (file+olp (at-org-dir "/browser-tabs.org") "inbox" "facebook") "* TODO [#C] %? %U :browser_tab:facebook:")
        ("bw" "wikipedia" entry (file+olp (at-org-dir "/browser-tabs.org") "inbox" "wikipedia") "* TODO [#C] %? %U :browser_tab:wikipedia:")
        ("bi" "infosource" entry (file+olp (at-org-dir "/browser-tabs.org") "inbox" "infosources") "* TODO [#C] %? %U :browser_tab:infosource:")
        ("bk" "kitties" entry (file+olp (at-org-dir "/browser-tabs.org") "inbox" "kitties") "* TODO [#C] %? %U :browser_tab:kitty:")
        ("t" "tickets")
