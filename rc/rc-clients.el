...
(use-package jabber
  ...
  (progn
    ...
    (bind-key "C-c C-l" 'custom-jabber/insert-inlove-smile jabber-chat-mode-map)
    (bind-key "C-c C-k" 'custom-jabber/insert-kiss-smile jabber-chat-mode-map)
    (bind-key "C-c C-y" 'custom-jabber/insert-shy-smile jabber-chat-mode-map)
    (bind-key "C-c C-t" 'custom-jabber/insert-copyright-sign jabber-chat-mode-map)
