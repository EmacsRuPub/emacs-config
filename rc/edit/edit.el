...
(load (concat config-basedir "/rc/edit/rc-hexview.el"))
(load (concat config-basedir "/rc/edit/rc-joinlines.el"))
(load (concat config-basedir "/rc/edit/rc-parentheses.el"))
(load (concat config-basedir "/rc/edit/rc-rebox2.el"))
(load (concat config-basedir "/rc/edit/rc-wrap-region.el"))
(load (concat config-basedir "/rc/edit/rc-zencoding.el"))
