...
;; or add pgsrc to your `el-get' settings
;;
;; Usage
;;
;; pgsrc will first install PostgreSQL code style settings as c-mode-hook
;; and propose an adjusted sgml-mode for documentation editing. It also
;; comes with some nice tools for editing nodes:
;;
...
;; Implement PostgreSQL code style for PostgreSQL related buffers
...
;; To work on the documentation, the following can be helpful.
