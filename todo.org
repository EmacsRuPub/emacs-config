...
* TODO [#B] try to implement org workload display [2015-01-13 Вт 14:04] :emacs:ticket:orgmode:
** TODO refer to :code_snippets: (make org link here)
   SCHEDULED: <2015-02-01 Вс>
* TODO [#A] random orgmode code from sachac [2015-01-15 Чт 23:46] :emacs:ticket:orgmode:
** TODO refer to :code_snippets: (make org link here)
   SCHEDULED: <2015-02-01 Вс>
...
* TODO [#A] agenda command for displaying headlines without any TODO states (and maybe without priorities) [2015-01-29 Чт 00:19] :orgmode:emacs:ticket:
