...
* TODO maybe generalize (otherwise reimplement) jabber quoting for ERC :fix:investigate:erc:
...
* TODO ERC: separate list of joined channels to switch      :investigate:erc:
* TODO ERC: nick and other things highlighting                          :erc:
...
* TODO add some neat snippets or custom defuns for erc commands (e.g. "/MSG user-or-channel message") :erc:
* TODO add some kind of regexp to select-erc-buffer to exclude server buffer itself :erc:
...
* TODO ERC: generalize credentials provision (e.g. for multiple accounts)[2014-06-23 Пн 00:18] :emacs:ticket:erc:
* TODO ERC: bots [2014-06-23 Пн 00:22]                     :emacs:ticket:erc:
