...
* TODO [#A] check and update work-capture template for stumpwm todo [2014-07-03 Чт 17:04] :emacs:ticket:
...
* TODO [#A] make some harness for custom major mode automatic activation (HINT: +auto-mode-alist) [2014-07-05 Сб 22:52] :emacs:ticket:
